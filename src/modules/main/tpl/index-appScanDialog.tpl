<!-- <section id="appDianoseWrapper" class="dialog col-xs-10 col-sm-8 col-md-5 col-lg-4 col-xs-offset-1 col-lg-offset-4 col-sm-offset-2 col-md-offset-3 none">
	<div class="dialog-header">
		<div class="dialog-title">
			<span>Remote Management with Tenda App</span>
	...
	<div class="dialog-container" style="padding:14px 22px;">
		...
		<div class="col-sm-6 hidden-xs" style="margin-top:20px;">
			...
			<ul>
				...
				<li>Get connection notification.</li>
				<li>Tap to accelerate WiFi.</li>
				<li>Tap to blacklist unknown users.</li>
			</ul>
		</div>
	
    </div>
</section> -->
<!-- <section id="appDianoseWrapper" class="dialog dialog-auto-wrap none">
	<div class="dialog-auto">
		<div class="dialog-auto-content">
			<div class="dialog-header">
				<div class="dialog-title">
					<span>Remote Management with Tenda App</span>
					<span class="dialog-close">×</span>
