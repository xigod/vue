<form class="form-horizontal" id="accessControl">
  ...
  <fieldset>
    ...
    <div id="urlFilterWrap" class="none">
      <div class="form-group">
        <label class="col-sm-4 col-md-3 control-label" for="urlFilterAllow" id="websiteLabel">Unblocked Websites</label>
        <div class="col-sm-5" style="padding-right: 0;">
          <!-- <div class="input-group">
            <input type="text" id="urlFilterAllow" name="urlFilterAllow" 
            maxlength="128" 
              class="form-control" data-option="{'type': 'url'}" >
              <span style="cursor: pointer;" class="input-group-addon" id="addUrl"> + <span>Add</span> </span>
          </div> -->
            <input type="text" id="urlFilterAllow" name="urlFilterAllow" 
            maxlength="128" class="form-control">
        </div>
        <div class="col-sm-1 radio-inline" style="padding-left: 15px;">
            <span class="picture pic-add" id="addUrl"> </span>
        </div>
      </div>
      <div class="form-group">
